                ...
                <div class="card-body">
                    ...
                    <div class="details-box">
                        @if($transaction->transaction_type === 'withdrawal')
                            <p><strong>Recipient Bank:</strong> {{ $transaction->recipient_bank_name }}</p>
                            ...
                            <p><strong>Swift Code:</strong> {{ $transaction->swift_code }}</p>
                            <p><strong>Bank Sort Code:</strong> {{ $transaction->bank_sort_code }}</p>
